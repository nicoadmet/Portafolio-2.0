...
const CasesSlider = () => {
  const baseProjects = [
    { 
      ...
      link: "https://tupagina.com/oniria"
    },
    { 
      id: 2, 
      ...
      link: "https://tupagina.com/ecocabanas"
    },
    { 
      id: 3, 
      ...
      link: "https://tupagina.com/freshness" // Reemplazar con links reales
    }
  ];
  ...
  return (
    <section id="proyectos" className="py-12 md:py-24 bg-[#050505] text-white overflow-hidden w-full font-sans border-b border-white/5">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                      <div className="max-w-md">
                        ...
                        <a 
                          ...
                          className="inline-flex items-center gap-3 px-5 py-3 rounded-full bg-white text-black text-[11px] md:text-xs font-black uppercase tracking-[0.2em] hover:bg-[#93c5fd] transition-all duration-300 group/btn shadow-xl shadow-white/5"
                        >
                          VER DEMO
