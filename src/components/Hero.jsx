    ...
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center bg-dark-bg text-white px-6 overflow-hidden font-sans">
      ...
      <div className="relative z-10 max-w-6xl text-left flex flex-col items-left">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <button className="group relative px-12 py-5 bg-white text-black font-bold rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 cursor-pointer">
            <span className="relative z-10">CONTACTAME ↗</span>
          </button>
          <button className="px-12 py-5 border border-white/10 rounded-xl text-gray-300 hover:border-white/30 hover:bg-white/5 transition-all duration-300 cursor-pointer">
            VER PROYECTOS
          </button>
        </div>
